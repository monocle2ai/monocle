...
## Version 0.8.0 (2026-05-01)

- Claude code instrumentation ([#529](https://github.com/monocle2ai/monocle/pull/529))
- Enhance monocle decorator to capture method call, input and output in span ([#533](https://github.com/monocle2ai/monocle/pull/533))
- Read MONOCLE_EXPORTER setting from .env.monocle ([#534](https://github.com/monocle2ai/monocle/pull/534))
- Increased timeouts and added retry logic for eval job submission ([#540](https://github.com/monocle2ai/monocle/pull/540))
