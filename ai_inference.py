...
from src.monocle_apptrace import setup_monocle_telemetry
setup_monocle_telemetry("dsdsdds")
import os


os.environ["AZURE_AI_CHAT_ENDPOINT"] = "https://okahu-openai-dev.openai.azure.com/openai/deployments/kshitiz-gpt"
os.environ["AZURE_AI_CHAT_KEY"] = "64739ec94cc048f0bccf993425b42b42"  # Keep
