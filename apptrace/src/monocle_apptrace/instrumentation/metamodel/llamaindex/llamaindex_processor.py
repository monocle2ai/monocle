...
class DelegationHandler(SpanHandler):
    ...
    def hydrate_span(self, to_wrap, wrapped, instance, args, kwargs, result, span, parent_span = None, ex:Exception = None, skip_events:list[str] = []) -> bool:
        ...
        return super().hydrate_span(agent_request_wrapper, wrapped, instance, args, kwargs, result, span, parent_span, ex, skip_events)
...
class LlamaIndexAgentHandler(SpanHandler):
    ...
    def hydrate_span(self, to_wrap, wrapped, instance, args, kwargs, result, span, parent_span = None, ex:Exception = None, skip_events:list[str] = []) -> bool:
        retval = super().hydrate_span(to_wrap, wrapped, instance, args, kwargs, result, span, parent_span, ex, skip_events)
