...
setup_monocle_telemetry(
    ...
    monocle_exporters_list='file'  # Only log to console to reduce trace files
    # Use 'file' only when you need to persist traces for analysis
)
...
LANGUAGE_MODEL = "gemini-2.0-flash"        # The AI model used for all agents
...
def search_products(query: str) -> dict:
    ...
    """
    # Simplified version - let ADK agent tracing handle the spans
    results = []
