...
def setup():
    ...
    if not os.getenv("MONOCLE_POSTGRES_CONNECTION_URL"):
    ...
    try:
        ...
        yield pg_exporter, custom_exporter
    finally:
        if instrumentor and instrumentor.is_instrumented_by_opentelemetry:
            instrumentor.uninstrument()


def test_langchain_sample_postgres(setup):
    pg_exporter, custom_exporter = setup
    ...
    for span in spans:
        ...
        if "span.type" in span_attributes and span_attributes["span.type"] in (
            ...
            assert span_attributes["entity.1.type"] == "inference.azure_openai" or \
                   span_attributes["entity.1.type"] == "inference.openai"
