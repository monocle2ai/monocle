...
KUBERNETES_ENV_NAME = "KUBERNETES_SERVICE_HOST"
...
KUBERNETES_IDENTIFIER_ENV_NAME = "HOSTNAME"
...
service_type_map = {
    ...
    KUBERNETES_ENV_NAME: KUBERNETES_SERVICE_NAME
}
...
service_name_map = {
    ...
    KUBERNETES_SERVICE_NAME: KUBERNETES_IDENTIFIER_ENV_NAME
}
