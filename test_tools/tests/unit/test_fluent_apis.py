...
def _load_spans(validator: TraceAssertion):
...
def test_tool_invocation_span(monocle_trace_asserter):
    _load_spans(monocle_trace_asserter)
...
def test_agent_invocation(monocle_trace_asserter):
    _load_spans(monocle_trace_asserter)
