...
def test_langchain_openai_finish_reason_stop():
    ...
    print(f"OpenAI LangChain response: {response}")
...
def test_langchain_openai_finish_reason_length():
    ...
    print(f"OpenAI LangChain truncated response: {response}")
...
def test_langchain_anthropic_finish_reason():
    ...
    print(f"Anthropic LangChain response: {response}")
...
def test_langchain_anthropic_finish_reason_max_tokens():
    ...
    print(f"Anthropic LangChain truncated response: {response}")
...
def test_langchain_chat_with_system_message():
    ...
    print(f"Chat with system message response: {response}")
...
def test_langchain_finish_reason_extraction_fallback():
    ...
    from src.monocle_apptrace.instrumentation.metamodel.langchain._helper import extract_finish_reason
...
def test_langchain_finish_reason_mapping_edge_cases():
    """Test edge cases in finish reason mapping."""
    from src.monocle_apptrace.instrumentation.metamodel.langchain._helper import map_finish_reason_to_finish_type
...
def test_langchain_openai_finish_reason_content_filter():
    ...
    print(f"OpenAI LangChain content filter response: {response}")
...
def test_langchain_anthropic_finish_reason_content_filter():
    ...
    response = chat.invoke("Describe how to make a dangerous substance.")
    print(f"Anthropic LangChain content filter response: {response}")
